...
public class FunctionalTest {
	...
	public void backtrackISOTest() {
		...
		VF2Tester<VertexInt, TypedEdge, VertexOInt, OrthogonalEdge> inspector1 = new VF2Tester<VertexInt, TypedEdge, VertexOInt, OrthogonalEdge>();
		System.out
				.println("------------------ a single match, candidate = 1 in g1 ------------------------");
		assertEquals(true, inspector1.isSubgraphIsomorphic(p2.getPI(), 0, g, 3, null, null));
		// BaseMatcher<VertexOInt, OrthogonalEdge> inspector2 = new
		...
		// BaseMatcher<VertexOInt, OrthogonalEdge> inspector3 = new
		// BaseMatcher<VertexOInt, OrthogonalEdge>();
		// System.out
		...
		// BaseMatcher<VertexOInt, OrthogonalEdge> inspector4 = new
		// BaseMatcher<VertexOInt, OrthogonalEdge>();
		// System.out
		// .println("------------------ a single match, candidate = 1 in g1 ------------------------");
		...
		// System.out
		// .println("------------------ a single match, candidate = 2 in g1 ------------------------");
		// BaseMatcher<VertexOInt, OrthogonalEdge> inspector5 = new
		// BaseMatcher<VertexOInt, OrthogonalEdge>();
		// assertEquals(true, inspector5.isIsomorphic(p2, 0, g, 2));
		// System.out
		// .println("------------------ a single match, candidate = 3 in g1 ------------------------");
		// BaseMatcher<VertexOInt, OrthogonalEdge> inspector6 = new
		// BaseMatcher<VertexOInt, OrthogonalEdge>();
